...
git sparse-checkout set packages/preview/resume-zh-cn
...
# 发布文件
bash ~/project/typst-resume-zh-cn/script/publish.sh ~/project/typst-official-packages-repo/packages/preview/resume-zh-cn/0.1.0
